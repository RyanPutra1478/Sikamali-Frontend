                            ...
                            <div key={index} className="member-form-card" style={{ background: '#f8fafc', padding: '1.5rem', borderRadius: '12px', marginBottom: '1.5rem', border: '1px solid #e2e8f0' }}>
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select name="hubungan_keluarga" value={form.hubungan_keluarga} onChange={(e) => handleChange(index, e)} className="input-field">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select name="pendidikan" value={form.pendidikan} onChange={(e) => handleChange(index, e)} className="input-field">
                                            <option value="">Pilih</option>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input name="pekerjaan" value={form.pekerjaan} onChange={(e) => handleChange(index, e)} placeholder="Contoh: Petani, PNS, Swasta" className="input-field" />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select name="status_perkawinan" value={form.status_perkawinan} onChange={(e) => handleChange(index, e)} className="input-field">
                                            <option value="">Pilih</option>
