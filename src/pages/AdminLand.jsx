                    ...
                    <div className="photo-column">
                      ...
                      <div className="photo-frame">
                        {selectedItem.foto_rumah ? (
                          <img 
                            src={`${import.meta.env.VITE_API_URL || "http://192.168.0.246:5000/api"}/land/foto/${selectedItem.foto_rumah}`} 
                            alt="Foto Rumah" 
                            style={{ cursor: 'pointer' }}
                            onClick={() => setPreviewImage(`${import.meta.env.VITE_API_URL || "http://192.168.0.246:5000/api"}/land/foto/${selectedItem.foto_rumah}`)}
                          />
                        ) : (
